...
namespace Gauss.TccUnifaat.MVC.Areas.Admin.Controllers
{
    ...
    public class DisciplinasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DisciplinaId,Nome,TurmaId,DataCadastro")] Disciplina disciplina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("DisciplinaId,Nome,TurmaId,DataCadastro")] Disciplina disciplina)
        {
